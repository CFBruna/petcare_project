...
from .factories import BrandFactory, CategoryFactory, ProductLotFactory, SaleFactory
...
class TestSaleItemFormSet:
    ...
    def test_formset_is_invalid_if_total_quantity_exceeds_stock_for_same_lot(self):
        lot = ProductLotFactory(quantity=10)
        sale = SaleFactory()
        formset_data = {
            "items-TOTAL_FORMS": "2",
